...
<div style="margin: auto; padding-top: 64px">
    <img src="<?php echo ROOTDIR;?>/images/tournaments/escape_gaming_masters2.png" width="100%" style="border-radius: 2px"/>
</div>
...
<fieldset id="instructions">
    ...
    <div class="double-outer-border">
        <div class="double-inner-border">
            ...
            <br />
            <br />
             <span class="text-primary">For rules and settings see official announcement <a href="http://escape.gg/">link</a>.</span>
            <br />
            <br />
