...
<div style="margin: auto; padding-top: 64px">
    <img src="<?php echo ROOTDIR;?>/images/tournaments/escape_gaming_masters.jpg" width="100%" style="border-radius: 2px"/>
</div>
...
<fieldset id="instructions">
    ...
    <div class="double-outer-border">
        <div class="double-inner-border">
            ...
            <br />
            <br />
             <span class="text-primary">For rules and settings see <a href="http://escape.gg/escape-gaming-masters/">link</a>.
             There will be 2 global bans for each player (nobody can choose any of these civs later), followed by 3 hidden bans per player. These
             are revealed before picking. In the end 3 civs are left to pick from in hidden mode. </span>
            <br />
            <br />
