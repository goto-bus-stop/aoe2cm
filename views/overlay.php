...
<div id="overlay" class="text-primary">
     <div id="waiting-message">
        ...
        <br />
            <input type="text"
                 class="inset-input copy-url"
                 value="http://<?php echo $_SERVER['HTTP_HOST'].ROOTDIR.'/join?code='.$code; ?>"
                 readonly>
        </p>
        <span>
            <a href='<?php echo $previous; ?>'>
                <span class='back-icon'><?php echo $go_back; ?></span>
            </a>
        </span>
     </div>
     <div id="hosting-message">
        <h2><span><?php echo _("Please wait..."); ?></span></h2>
        <p><?php echo _("Waiting for captains to join. Send this code first to host then guest:"); ?> <br />
            <input type="text" class="inset-input" value="<?php echo $code; ?>" readonly> <br />
            <?php echo _("Alternatively send this url to the host captian:"); ?> <br />
            <input type="text"
                 class="inset-input copy-url"
                 value="http://<?php echo $_SERVER['HTTP_HOST'].ROOTDIR.'/join?role=0&code='.$code; ?>"
                 readonly><br />
            <?php echo _("and this url to the guest captain:"); ?><br />
            <input type="text"
                 class="inset-input copy-url"
                 value="http://<?php echo $_SERVER['HTTP_HOST'].ROOTDIR.'/join?role=1&code='.$code; ?>"
                 readonly>
        </p>
