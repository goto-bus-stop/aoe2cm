...
<div class="title">
	<span id="aoe-title"><?php echo _("Age of Empires II"); ?></span> <span id="cm-logo"></span> <span id="cm-title"><?php echo _("Captains mode"); ?></span>
</div>
      	...
      	<fieldset id="instructions">
			...
			<div class="double-outer-border">
				<div class="double-inner-border">
					<span class="text-primary"><?php echo _("Captains mode is a turn-based civilization picker. Each captain can <span class='green-glow'>pick</span> and <span class='red-glow'>ban</span> civilizations in a predefined order. Bans prevent the opponent's captain from picking the civilizations. "); ?></span> <br /> <br />
					<span class="text-primary"><?php echo _("For each turn captains have <b>30 seconds</b>. In case of timeout a random civilization is picked for the captain or no civilization gets banned."); ?></span> <br /> <br />
					<span class="text-primary"><?php echo _("There are also extension available for tournaments. <b>Hidden</b> option (black corners) hides the civilization choices until they are explicitely showed (visible in the timeline at the top). <b>Global</b> pick or bans disables the civilization for later turns. For other specific settings, please refer to the preset descriptions."); ?> </span> <br /><br />
					<span class="text-primary"><?php echo _("<b>Practice</b> mode is for testing purposes, where both sides are controlled by a single player."); ?></span> <br />
				</div>
			</div>
		</fieldset>
      	...
      	<div class="pure-g">
			<div class="pure-u-1-1 selectionbox" >
				<div id="new_game" class="card">
					...
					<div class="pure-g">
						<div class="pure-u-1-2"><div class="gametype shadowbutton blue-glow"  ><?php echo _("1 v 1"); ?></div></div>
						<div class="pure-u-1-2"><div class="gametype shadowbutton red-glow"   ><?php echo _("2 v 2"); ?></div> </div>
						<div class="pure-u-1-2"><div class="gametype shadowbutton green-glow" ><?php echo _("3 v 3"); ?></div></div>
						<div class="pure-u-1-2"><div class="gametype shadowbutton yellow-glow"><?php echo _("4 v 4"); ?></div> </div>
					</div>
				</div>
			</div>
		</div>
      	...
      	<div class="pure-g">
			<div class="pure-u-1-1 selectionbox" >
				<div id="new_game" class="home_card card">
					<h2><span><?php echo _("Quick draft"); ?></span></h2>
					<div class="pure-g">
						<div class="pure-u-1-2"><div class="gametype-practice shadowbutton blue-glow"  ><?php echo _("1 v 1"); ?></div></div>
						<div class="pure-u-1-2"><div class="gametype-practice shadowbutton red-glow"   ><?php echo _("2 v 2"); ?></div> </div>
						<div class="pure-u-1-2"><div class="gametype-practice shadowbutton green-glow" ><?php echo _("3 v 3"); ?></div></div>
						<div class="pure-u-1-2"><div class="gametype-practice shadowbutton yellow-glow"><?php echo _("4 v 4"); ?></div> </div>
					</div>
				</div>
			</div>
		</div>
