...
class EpiRoute
{
  ...
  public function load($file)
  {
    ...
    if(!file_exists($file))
    {
      ...
      die("Config file ({$file}) does not exist"); // need to simulate same behavior if exceptions are turned off
    }
   ...
   * @static method
   */
  public function redirect($url, $code = null, $offDomain = false, $refresh=false)
  {
    $continue = !empty($url);
